...
def get_data_location():
    data_folder = "/Users/aykhanam/Downloads/landmark_images"
    if os.path.exists(data_folder):
        return data_folder
    else:
        raise IOError("The dataset directory does not exist. Please ensure the dataset is present in the specified folder.")
